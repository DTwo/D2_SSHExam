...
public class Priceconfig implements java.io.Serializable {
	...
	public Priceconfig(int priceConfigId, Customer customer, String custCode, String type, String priveListCol,
			String activity) {
	...
	public Priceconfig(int priceConfigId, Customer customer, String custCode, String type, String displayName,
			String priveListCol, Integer excelCol, String activity, Price price) {
		this.priceConfigId = priceConfigId;
		this.customer = customer;
		this.custCode = custCode;
		this.type = type;
