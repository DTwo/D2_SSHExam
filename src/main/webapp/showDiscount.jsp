	...
	<div id="base" class="">
		...
		<form action="" method="post">
			<div id="u242" class="ax_html_button">
				<input id="u242_input" type="submit" value="查询" />
			</div>
			...
			<!-- discount_name 折扣名称 (Text Field) -->
			<div id="u245" class="ax_text_field">
				<input id="u245_input" type="text" value="" name="discount_name" />
			</div>

			<!-- Unnamed (Shape) -->
			<div id="u246" class="ax_paragraph">
				<img id="u246_img" class="img "
					src="resources/images/transparent.gif" />
				<!-- Unnamed () -->
			...
			<!-- Unnamed (Text Field) -->
			<div id="u248" class="ax_text_field">
				<input id="u248_input" type="text" value="" name="type" />
			</div>

			<!-- Unnamed (HTML Button) -->
			<div id="u249" class="ax_html_button">
				<input id="u249_input" type="submit" value="新增" />
			</div>
		</form>
		<!-- Unnamed (Horizontal Line) -->
