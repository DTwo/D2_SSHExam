...
<script src="files/折扣新增/data.js"></script>
...
<body>
	<div id="base" class="">
		...
		<div id="u173" class="ax_vertical_line">
			<img id="u173_start" class="img "
				src="resources/images/transparent.gif" alt="u173_start" /> <img
		...
		<!-- Unnamed (Horizontal Line) -->
		<div id="u179" class="ax_horizontal_line">
			<img id="u179_start" class="img "
				src="resources/images/transparent.gif" alt="u179_start" /> <img
				id="u179_end" class="img " src="resources/images/transparent.gif"
				alt="u179_end" /> <img id="u179_line" class="img "
