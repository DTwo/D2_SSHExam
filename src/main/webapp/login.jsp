...
<body>
	...
	<div id="base" class="">
			...
			<div id="u5_children" class="u5_children">
					...
					<div id="u42_children" class="u42_children"
						...
						<div id="u47" class="ax_tree_node treenode">
							...
							<div id="u48" class="" selectiongroup="u5_tree_group">
								<img id="u48_img" class="img " src="images/登录/u48.png" />
								<!-- Unnamed () -->
						...
						<div id="u53" class="ax_tree_node treenode">
							...
							<div id="u54" class="" selectiongroup="u5_tree_group">
								<img id="u54_img" class="img " src="images/登录/u54.png" />
								<!-- Unnamed () -->
				...
				<div id="u56" class="ax_tree_node treenode">
					...
					<div id="u57" class="ax_image">
						<img id="u57_img" class="img " src="images/登录/u10.png" />
						<!-- Unnamed () -->
				...
				<div id="u64" class="ax_tree_node treenode">
					...
					<div id="u65" class="ax_image">
						<img id="u65_img" class="img " src="images/登录/u10.png" />
						<!-- Unnamed () -->
					...
					<!-- Unnamed (Shape) -->
					<div id="u67" class="" selectiongroup="u5_tree_group">
						<img id="u67_img" class="img "
							src="resources/images/transparent.gif" />
						<!-- Unnamed () -->
					...
					<div id="u64_children" class="u64_children"
						...
						<div id="u69" class="ax_tree_node treenode">
							<!-- Unnamed (Shape) -->
							<div id="u70" class="" selectiongroup="u5_tree_group">
								<img id="u70_img" class="img "
									src="resources/images/transparent.gif" />
								<!-- Unnamed () -->
						...
						<!-- Unnamed (Tree Node) -->
						<div id="u72" class="ax_tree_node treenode">
							<!-- Unnamed (Shape) -->
				...
				<div id="u78" class="ax_tree_node treenode">
					...
					<div id="u79" class="ax_image">
						<img id="u79_img" class="img " src="images/登录/u10.png" />
						<!-- Unnamed () -->
					...
					<!-- Unnamed (Shape) -->
					<div id="u81" class="" selectiongroup="u5_tree_group">
						<img id="u81_img" class="img "
							src="resources/images/transparent.gif" />
						<!-- Unnamed () -->
					...
					<div id="u78_children" class="u78_children"
						style="visibility: hidden;">
				...
				<div id="u86" class="ax_tree_node treenode">
					...
					<div id="u87" class="ax_image">
						<img id="u87_img" class="img " src="images/登录/u10.png" />
						<!-- Unnamed () -->
					...
					<!-- Unnamed (Shape) -->
					<div id="u89" class="" selectiongroup="u5_tree_group">
					...
					<div id="u86_children" class="u86_children"
						style="visibility: hidden;">

						<!-- Unnamed (Tree Node) -->
						<div id="u91" class="ax_tree_node treenode">
							<!-- Unnamed (Shape) -->
							<div id="u92" class="" selectiongroup="u5_tree_group">
								<img id="u92_img" class="img "
									src="resources/images/transparent.gif" />
								<!-- Unnamed () -->
		...
		<!-- Unnamed (Tree) -->
		<div id="u94" class="ax_tree_node treeroot">
			<div id="u94_children" class="u94_children">

				<!-- Unnamed (Tree Node) -->
				<div id="u95" class="ax_tree_node treenode">
					<!-- Unnamed (Shape) -->
					<div id="u96" class="" selectiongroup="u94_tree_group">
		...
		<!-- Unnamed (Tree) -->
		<div id="u98" class="ax_tree_node treeroot">
			<div id="u98_children" class="u98_children">

				<!-- Unnamed (Tree Node) -->
				<div id="u99" class="ax_tree_node treenode">
					<!-- Unnamed (Shape) -->
					<div id="u100" class="" selectiongroup="u98_tree_group">
						<img id="u100_img" class="img "
							src="resources/images/transparent.gif" />
						<!-- Unnamed () -->
		...
		<!-- Unnamed (Shape) -->
		<div id="u102" class="ax_h1">
			<img id="u102_img" class="img "
				src="resources/images/transparent.gif" />
			<!-- Unnamed () -->
		...
		<!-- Unnamed (Horizontal Line) -->
		<div id="u104" class="ax_horizontal_line">
			<img id="u104_start" class="img "
				src="resources/images/transparent.gif" alt="u104_start" /> <img
				id="u104_end" class="img " src="resources/images/transparent.gif"
				alt="u104_end" /> <img id="u104_line" class="img "
				src="images/登录/u104_line.png" alt="u104_line" />
		</div>

		<!-- Unnamed (Vertical Line) -->
		<div id="u105" class="ax_vertical_line">
			<img id="u105_start" class="img "
				src="resources/images/transparent.gif" alt="u105_start" /> <img
				id="u105_end" class="img " src="resources/images/transparent.gif"
				alt="u105_end" /> <img id="u105_line" class="img "
				src="images/登录/u105_line.png" alt="u105_line" />
		</div>

		<!-- Unnamed (Account panel) -->

		<!-- Unnamed (Shape) -->
		<div id="u107">
			<div class="container col-lg-4  vertical-center">
				<h3>销售订单管理系统</h3>
				<s:form action="LoginAction_execute.action" method="post">
					<div class="table table-responsive">
						<table class="table table-striped">
							<tr class="info">
								<td colspan="2"><s:radio label="用户类型" name="type"
										list="{'销售经理','业务员','财务'}" /></td>
							</tr>
							...
							<tr>
								<td colspan="2"><button type="submit" class="btn btn-default col-lg-12">提交</button></td>
							</tr>
							<tr>
								<td colspan="2" class="danger"><span
									class="label label-danger">${errMsg}</span></td>
							</tr>
						</table>
					</div>
				</s:form>
