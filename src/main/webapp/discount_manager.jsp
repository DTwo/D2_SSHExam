...
<link href="files/折扣应用记录/styles.css" type="text/css" rel="stylesheet" />
...
<script src="files/折扣应用记录/data.js"></script>
	...
	<div id="base" class="">
		...
		<div id="u4" class="ax_horizontal_line">
			<img id="u4_start" class="img "
				...
				src="images/登录/u4_line.png" alt="u4_line" />
		</div>
		...
		<div id="u5" class="ax_tree_node treeroot">
			<div id="u5_children" class="u5_children">
					...
					<div id="u9_children" class="u9_children"
						...
						<div id="u14" class="ax_tree_node treenode">
							...
							<div id="u15" class="" selectiongroup="u5_tree_group">
								<img id="u15_img" class="img " src="images/折扣查询/u15.png" />
								<!-- Unnamed () -->
						...
						<div id="u23" class="ax_tree_node treenode">
							<!-- Unnamed (Shape) -->
							<div id="u24" class="" selectiongroup="u5_tree_group">
				...
				<!-- Unnamed (Tree Node) -->
				<div id="u26" class="ax_tree_node treenode">

					<!-- Unnamed (Image) -->
					<div id="u27" class="ax_image">
						<img id="u27_img" class="img " src="images/登录/u10.png" />
						<!-- Unnamed () -->
					...
					<div id="u26_children" class="u26_children"
						style="visibility: hidden;">
						...
						<div id="u34" class="ax_tree_node treenode">
							<!-- Unnamed (Shape) -->
							<div id="u35" class="" selectiongroup="u5_tree_group">
								<img id="u35_img" class="img "
									src="resources/images/transparent.gif" />
								<!-- Unnamed () -->
				...
				<div id="u37" class="ax_tree_node treenode">
					...
					<div id="u38" class="ax_image">
						<img id="u38_img" class="img " src="images/登录/u10.png" />
						<!-- Unnamed () -->
					...
					<div id="u37_children" class="u37_children"
						style="visibility: hidden;">

						<!-- Unnamed (Tree Node) -->
						<div id="u42" class="ax_tree_node treenode">
							<!-- Unnamed (Shape) -->
							<div id="u43" class="" selectiongroup="u5_tree_group">
				...
				<!-- Unnamed (Tree Node) -->
				<div id="u45" class="ax_tree_node treenode">

					<!-- Unnamed (Image) -->
					<div id="u46" class="ax_image">
						<img id="u46_img" class="img " src="images/登录/u10.png" />
						<!-- Unnamed () -->
					...
					<div id="u45_children" class="u45_children"
						style="visibility: hidden;">
						...
						<div id="u50" class="ax_tree_node treenode">
							...
							<div id="u51" class="" selectiongroup="u5_tree_group">
								<img id="u51_img" class="img " src="images/手工订单/u56.png" />
								<!-- Unnamed () -->
						...
						<div id="u56" class="ax_tree_node treenode">
							<!-- Unnamed (Shape) -->
							<div id="u57" class="" selectiongroup="u5_tree_group">
								<img id="u57_img" class="img "
									src="resources/images/transparent.gif" />
								<!-- Unnamed () -->
				...
				<!-- Unnamed (Tree Node) -->
				<div id="u59" class="ax_tree_node treenode">

					<!-- Unnamed (Image) -->
					<div id="u60" class="ax_image">
						<img id="u60_img" class="img " src="images/登录/u10_selected.png" />
						<!-- Unnamed () -->
					...
					<div id="u59_children" class="u59_children">
						...
						<div id="u70" class="ax_tree_node treenode">
							...
							<div id="u71" class="ax_image">
								<img id="u71_img" class="img " src="images/登录/u10_selected.png" />
								<!-- Unnamed () -->
				...
				<div id="u81" class="ax_tree_node treenode">
					...
					<!-- Unnamed (Shape) -->
					<div id="u84" class="" selectiongroup="u5_tree_group">
						<img id="u84_img" class="img "
							src="resources/images/transparent.gif" />
						<!-- Unnamed () -->
					...
					<div id="u81_children" class="u81_children"
						style="visibility: hidden;">

						<!-- Unnamed (Tree Node) -->
						<div id="u86" class="ax_tree_node treenode">
							<!-- Unnamed (Shape) -->
							<div id="u87" class="" selectiongroup="u5_tree_group">
								<img id="u87_img" class="img "
									src="resources/images/transparent.gif" />
								<!-- Unnamed () -->
						...
						<!-- Unnamed (Tree Node) -->
						<div id="u89" class="ax_tree_node treenode">
							<!-- Unnamed (Shape) -->
				...
				<div id="u98" class="ax_tree_node treenode">
					...
					<div id="u99" class="ax_image">
						<img id="u99_img" class="img " src="images/登录/u10.png" />
						<!-- Unnamed () -->
				...
				<div id="u109" class="ax_tree_node treenode">
					...
					<div id="u110" class="ax_image">
						<img id="u110_img" class="img " src="images/登录/u10.png" />
						<!-- Unnamed () -->
				...
				<!-- Unnamed (Tree Node) -->
				<div id="u120" class="ax_tree_node treenode">

					<!-- Unnamed (Image) -->
					<div id="u121" class="ax_image">
						<img id="u121_img" class="img " src="images/登录/u10.png" />
						<!-- Unnamed () -->
					...
					<!-- Unnamed (Shape) -->
					<div id="u123" class="" selectiongroup="u5_tree_group">
						<img id="u123_img" class="img "
							src="resources/images/transparent.gif" />
						<!-- Unnamed () -->
					...
					<div id="u120_children" class="u120_children"
						...
						<div id="u125" class="ax_tree_node treenode">
							<!-- Unnamed (Shape) -->
							<div id="u126" class="" selectiongroup="u5_tree_group">
						...
						<!-- Unnamed (Tree Node) -->
						<div id="u128" class="ax_tree_node treenode">
							<!-- Unnamed (Shape) -->
							<div id="u129" class="" selectiongroup="u5_tree_group">
		...
		<!-- Unnamed (Tree) -->
		<div id="u131" class="ax_tree_node treeroot">
			<div id="u131_children" class="u131_children">

				<!-- Unnamed (Tree Node) -->
				<div id="u132" class="ax_tree_node treenode">
					<!-- Unnamed (Shape) -->
					<div id="u133" class="" selectiongroup="u131_tree_group">
		...
		<!-- Unnamed (Tree) -->
		<div id="u135" class="ax_tree_node treeroot">
			<div id="u135_children" class="u135_children">

				<!-- Unnamed (Tree Node) -->
				<div id="u136" class="ax_tree_node treenode">
					<!-- Unnamed (Shape) -->
					<div id="u137" class="" selectiongroup="u135_tree_group">
						<img id="u137_img" class="img "
							src="resources/images/transparent.gif" />
						<!-- Unnamed () -->
		...
		<!-- Unnamed (Shape) -->
		<div id="u139" class="ax_h1">
			<img id="u139_img" class="img "
				src="resources/images/transparent.gif" />
			<!-- Unnamed () -->
		...
		<div id="u142" class="ax_vertical_line">
			<img id="u142_start" class="img "
				src="resources/images/transparent.gif" alt="u142_start" /> <img
				id="u142_end" class="img " src="resources/images/transparent.gif"
				alt="u142_end" /> <img id="u142_line" class="img "
				src="images/登录/u105_line.png" alt="u142_line" />
		</div>
		...
		<div id="u210">
			<table class="table">
				...
				<s:iterator value="onDiscountAppliedRecords">
					<tr>
						<td>${appliedId}</td>
						<td>${dicountName}</td>
						<td>${custCode}</td>
						<td>${adnIdentifyNum}</td>
						<td>${appliedAmount}</td>
						<td>${appliedDate}</td>
						<td><s:if test="%{cancel==null}"></s:if> <s:else>Y</s:else></td>
						<td>${cancelDate}</td>
					</tr>
				</s:iterator>
		...
		<div id="u214" class="ax_paragraph">
			...
			<div id="u215" class="text">
				<p>
					<span>折扣金额</span><span>：${omSpecialDiscount.amount}</span>
				</p>
			</div>
		</div>
		...
		<div id="u216" class="ax_paragraph">
			<img id="u216_img" class="img "
				src="resources/images/transparent.gif" />
			<!-- Unnamed () -->
			<div id="u217" class="text">
				<p>
					<span>已用</span><span>金额</span><span>：${omSpecialDiscount.appliedAmount}</span>
				</p>
			</div>
		</div>
		...
		<div id="u218" class="ax_paragraph">
			<img id="u218_img" class="img "
				src="resources/images/transparent.gif" />
			<!-- Unnamed () -->
			<div id="u219" class="text">
				<p>
					<span>折扣余额</span><span>：${omSpecialDiscount.amount - omSpecialDiscount.appliedAmount}</span>
				</p>
			</div>
		</div>
